    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <FormField control={form.control} name="topic"
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Textarea placeholder="Derivatives and integrals" {...field} className="input" />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )} />

                <FormField control={form.control} name="voice"
                    render={({ field }) => (
                        <FormItem>
                ...
                <FormField control={form.control} name="style"
                    render={({ field }) => (
                        <FormItem>
                ...
                <FormField control={form.control} name="duration"
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Esttimated session duration(mins)</FormLabel>
                            <FormControl>
